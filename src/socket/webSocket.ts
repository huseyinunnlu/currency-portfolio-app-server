            ...
            try {
                ...
                switch (parsedData._id) {
                    ...
                    case 1:
                        ...
                        const currencyKeysWithSocketId = cacheManager.get(
                            'currencyKeysWithSocketId'
                        ) as CurrencyKeysWithSocketIdTypes[];
                        const selectedCurrencyKey = currencyKeysWithSocketId.find(
                            (currency: any) => currency.id === parsedData._i
                        );
